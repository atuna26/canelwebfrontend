...
const Mine = () => {
  ...
  return (
    <div className='flex flex-col gap-10 w-full'> 
        ...
        <div className='flex justify-start items-center flex-wrap gap-5 mb-5'>
          {images.map((image) => (
            <img key={image._id} src={image.src} alt={image.alt} className='md:w-[300px] md:h-[300px] w-[250px] h-[250px] rounded-lg shadow-lg hover:scale-105 transition-transform duration-300 cursor-pointer' 
