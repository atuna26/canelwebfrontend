...
import EbatliProducts from "./EbatliProduct";
import PavelProducts from "./PavelProduct";
import PlakaProducts from "./PlakaProduct";
import BlokProducts from "./BlokProducts";
import Contact from "./contact";
import Compare from "./compare";
import Footer from "./homeLandingPage/components/Footer";
          ...
          <div className={` ${styles.flexStart}`}>
            <div className={`${styles.boxWidth}`}>
              <Routes>
                ...
                />
                <Route path="/mermerler/ebatli-fayans-mermerler" element={<EbatliProducts setItems={itemAdd} />} />
                <Route path="/mermerler/paver-mermerler" element={<PavelProducts setItems={itemAdd} />} />
                <Route path="/mermerler/plaka-mermerler" element={<PlakaProducts setItems={itemAdd} />} />
                <Route path="/mermerler/blok-mermerler" element={<BlokProducts setItems={itemAdd} />} />
                ...
                <Route path="/urunler/karşılaştır" element={<Compare />} />
