...
const Mine = () => {
  return (
    ...
    >
      ...
      <button
        type="button"
        className="text-primary border rounded-sm mt-2 bg-white border-white h focus:ring-4 focus:outline-none focus:ring-white-300 font-medium text-sm px-5 py-2.5 text-center me-2 md:mb-2 mb-10"
      >
        Tüm Ocaklar
      </button>
