import slabGalleryA from "../../assets/slabGalleryE.jpeg"
     ...
     <section
            ...
            >
              <h2 className="text-primary text-3xl  font-light font-abel">
                      <span className="border-t-2 border-l-2 pl-1">Plaka</span>
                      <span className="border-b-2 border-r-2 pr-1"> Galeri</span>
                    </h2>
